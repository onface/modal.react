...
/******/ 	__webpack_require__.p = "/modal.react/0.1.0";
/******/
...
var Button = __webpack_require__("./node_modules/button.react/lib/index.js");
var Modal = __webpack_require__("./lib/index.js");
...
var _icon = __webpack_require__("./node_modules/icon.react/lib/index.js");
        ...
        value: function render() {
            ...
            return __webpack_require__("./node_modules/react/index.js").createElement(
                ...
                function (self) {
                    ...
                    return __webpack_require__("./node_modules/react/index.js").createElement(
                        "div",
                        { className: self.props.prefixClassName + "-tip " + self.props.prefixClassName + "-tip--" + self.props.type },
                        __webpack_require__("./node_modules/react/index.js").createElement(
                            "div",
                            { className: self.props.prefixClassName + "-tip-title" },
                            __webpack_require__("./node_modules/react/index.js").createElement(
                                "span",
                                { className: self.props.prefixClassName + "-tip-title-icon" },
                                __webpack_require__("./node_modules/react/index.js").createElement(_icon2.default, { type: iconMap[self.props.type] })
                            ),
                            self.props.title
                        ),
                        __webpack_require__("./node_modules/react/index.js").createElement(
                            "div",
                            { className: self.props.prefixClassName + "-tip-content" },
                            self.props.content
                        )
                    );
                }
...
var _Command = __webpack_require__("./lib/Command.js");
...
module.exports = function confirm(settings, callback) {
    ...
    settings = (0, _safeExtend2.default)(true, {
        title: '请确认操作'
    }, settings);
    (0, _reactDom.render)((0, _reactDom.createPortal)(__webpack_require__("./node_modules/react/index.js").createElement(_Command2.default, {
        type: "confirm",
...
var _button = __webpack_require__("./node_modules/button.react/lib/index.js");
...
var Modal = (_temp = _class = function (_Component) {
    ...
    _createClass(Modal, [{
        ...
        value: function render() {
            var self = this;
            var rootClassName = [self.props.prefixClassName, _util2.default.themes(self.props)];
            ...
            return [(0, _reactDom.createPortal)(__webpack_require__("./node_modules/react/index.js").createElement("div", { className: self.props.prefixClassName + "-mask" }), document.body), (0, _reactDom.createPortal)(__webpack_require__("./node_modules/react/index.js").createElement(
                "div",
                { className: self.props.prefixClassName + "-wrap" },
                __webpack_require__("./node_modules/react/index.js").createElement(
                    "div",
                    {
                    ...
                    __webpack_require__("./node_modules/react/index.js").createElement(
                        "div",
                        { className: self.props.prefixClassName + "-body" },
                        typeof self.props.children === 'function' ? self.props.children(self) : self.props.children
                    ),
    ...
    this.emitOk = function () {
        var self = _this2;
        if (self.state.busy.ok) {
            return;
        }
        var output = void 0;
        if (typeof self.props.onAction === 'function') {
...
Modal.success = __webpack_require__("./lib/success.js");
Modal.error = __webpack_require__("./lib/error.js");
Modal.warning = __webpack_require__("./lib/warning.js");
Modal.warn = __webpack_require__("./lib/warning.js");
Modal.info = __webpack_require__("./lib/info.js");
Modal.confirm = __webpack_require__("./lib/confirm.js");
__webpack_require__("./lib/props.js").default(Modal);
...
exports.default = function (app) {
    app.defaultProps = {
        ...
        header: function header(self) {
            return __webpack_require__("./node_modules/react/index.js").createElement(
                'div',
                { className: self.props.prefixClassName + '-header' },
                __webpack_require__("./node_modules/react/index.js").createElement(
                    'div',
                    { className: self.props.prefixClassName + '-header-title' },
                    self.props.title
                ),
                __webpack_require__("./node_modules/react/index.js").createElement(
                    'div',
                    { className: self.props.prefixClassName + '-header-close', onClick: function onClick() {
                            self.emitClose();
                        } },
                    '\xD7'
                )
        ...
        footer: function footer(self) {
            var Button = self.components.Button;
            return __webpack_require__("./node_modules/react/index.js").createElement(
                'div',
                { className: self.props.prefixClassName + '-footer' },
                self.props.close ? typeof self.props.close === 'string' ? __webpack_require__("./node_modules/react/index.js").createElement(
                    Button,
                    {
                    ...
                    self.props.close
                ) : self.props.close(self) : null,
                self.props.ok ? typeof self.props.ok === 'string' ? __webpack_require__("./node_modules/react/index.js").createElement(
                    Button,
                    {
...
/***/ "./node_modules/button.react/lib/ButtonGroup.js":
/***/ (function(module, exports, __webpack_require__) {
...
var ButtonGroup = function (_Component) {
    ...
    _createClass(ButtonGroup, [{
        ...
        value: function render() {
            ...
            var rootClassName = [props.prefixClassName, _util2.default.themes(props)].join(' ');
            return __webpack_require__("./node_modules/react/index.js").createElement(
                "div",
                {
                    className: rootClassName
...
__webpack_require__("./node_modules/button.react/lib/ButtonGroupProps.js").default(ButtonGroup);

/***/ }),

/***/ "./node_modules/button.react/lib/ButtonGroupProps.js":
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = function (app) {
    app.defaultProps = {
        prefixClassName: 'face-btn-group',
        themes: '',
        type: '',
        // loading: false,
        // diasbled: false,
    ...
    app.propTypes = {
        ...
        diasbled: _propTypes2.default.bool,
...
/***/ "./node_modules/button.react/lib/getProps.js":
/***/ (function(module, exports, __webpack_require__) {
...
function getProps(props, state) {
    var rootClassName = [props.prefixClassName, _util2.default.themes(props), props.prefixClassName, props.icon ? props.prefixClassName + "--icon" : '', props.loading ? props.prefixClassName + "--loading" : '', props.loading ? props.prefixClassName + "--loading" : '', props.type ? props.prefixClassName + "--" + props.type : '', props.dashed ? props.prefixClassName + "--dashed" : '', props.ghost ? props.prefixClassName + "--ghost" : '', props.prepend ? props.prefixClassName + "--prepend" : '', props.append ? props.prefixClassName + "--append" : '', props.size ? props.prefixClassName + "--" + props.size : ''];
    if (typeof state !== 'undefined') {
        rootClassName.push(state.shadow ? props.prefixClassName + "--clicked" : '');
    }
    rootClassName = rootClassName.join(' ');
    var cloneProps = (0, _extend2.default)(true, {}, props);
...
/***/ "./node_modules/button.react/lib/index.css":
/***/ (function(module, exports, __webpack_require__) {

// style-loader: Adds some css to the DOM by adding a <style> tag

// load the styles
var content = __webpack_require__("./node_modules/css-loader/index.js!./node_modules/less-loader/index.js!./node_modules/button.react/lib/index.css");
if(typeof content === 'string') content = [[module.i, content, '']];
// add the styles to the DOM
var update = __webpack_require__("./node_modules/style-loader/addStyles.js")(content, {});
if(content.locals) module.exports = content.locals;
...
/***/ "./node_modules/button.react/lib/index.js":
/***/ (function(module, exports, __webpack_require__) {
...
var _getProps = __webpack_require__("./node_modules/button.react/lib/getProps.js");
...
__webpack_require__("./node_modules/button.react/lib/index.css");
var Button = (_temp = _class = function (_Component) {
    ...
    _createClass(Button, [{
        ...
        value: function render() {
            var self = this;
            var cloneProps = (0, _getProps2.default)(self.props, self.state);
            var rootProps = {
                ref: 'root',
    ...
    return Button;
}(_react.Component), _class.ButtonGroup = __webpack_require__("./node_modules/button.react/lib/ButtonGroup.js").default, _initialiseProps = function _initialiseProps() {
    var _this2 = this;

    this.proxyClick = function (e) {
        var self = _this2;
...
__webpack_require__("./node_modules/button.react/lib/props.js").default(Button);
...
/***/ "./node_modules/button.react/lib/props.js":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, ".face-modal-mask {\n  position: fixed;\n  top: 0;\n  right: 0;\n  left: 0;\n  bottom: 0;\n  background-color: #373737;\n  background-color: rgba(0, 0, 0, 0.65);\n  height: 100%;\n  z-index: 1051;\n}\n.face-modal-wrap {\n  z-index: 1151;\n  text-align: center;\n  position: fixed;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  white-space: nowrap;\n}\n.face-modal-wrap::after {\n  content: ' ';\n  display: inline-block;\n  height: 100%;\n  width: 0px;\n  background-color: transparent;\n  overflow: hidden;\n  vertical-align: middle;\n}\n.face-modal {\n  box-shadow: 0 0.3em 0.8em rgba(0, 0, 0, 0.15);\n  display: inline-block;\n  width: 35em;\n  text-align: left;\n  vertical-align: middle;\n  white-space: normal;\n}\n.face-modal-body {\n  background-color: white;\n  padding: 0.5em;\n}\n.face-modal-header {\n  position: relative;\n  padding: 1em 0.5em;\n  background-color: white;\n  border-top-left-radius: 0.3em;\n  border-top-right-radius: 0.3em;\n  border-bottom: 1px solid #eee;\n}\n.face-modal-header-title {\n  font-weight: bold;\n  font-size: 1.2em;\n}\n.face-modal-header-close {\n  position: absolute;\n  right: 0;\n  top: 0;\n  font-size: 2em;\n  color: #999;\n  padding: .35em;\n  line-height: 1;\n  cursor: pointer;\n}\n.face-modal-header-close:hover {\n  color: #d85c4b;\n}\n.face-modal--not-header .face-modal-body {\n  border-top-left-radius: 0.3em;\n  border-top-right-radius: 0.3em;\n}\n.face-modal--not-footer .face-modal-body {\n  border-bottom-left-radius: 0.3em;\n  border-bottom-right-radius: 0.3em;\n}\n.face-modal-footer {\n  padding: 0.5em;\n  text-align: right;\n  background-color: white;\n  border-bottom-left-radius: 0.3em;\n  border-bottom-right-radius: 0.3em;\n  border-top: 1px solid #eee;\n}\n.face-modal-tip--success .face-modal-tip-title-icon {\n  color: #5dc75d;\n}\n.face-modal-tip--info .face-modal-tip-title-icon {\n  color: #03a9f4;\n}\n.face-modal-tip--warning .face-modal-tip-title-icon {\n  color: #F2AD54;\n}\n.face-modal-tip--confirm .face-modal-tip-title-icon {\n  color: #F2AD54;\n}\n.face-modal-tip--danger .face-modal-tip-title-icon {\n  color: #d85c4b;\n}\n.face-modal-tip {\n  padding-left: 4em;\n}\n.face-modal-tip-title {\n  padding-top: .5em;\n  padding-bottom: .5em;\n  font-weight: bold;\n}\n.face-modal-tip-title-icon {\n  float: left;\n  margin-left: -1.5em;\n  font-weight: 300;\n  font-size: 1.5em;\n  margin-top: -0.17em;\n}\n.face-modal-tip-content {\n  padding-top: .5em;\n  padding-bottom: .5em;\n  color: #666;\n}\n.face-modal--themes-tip .face-modal-body {\n  padding-top: 1.5em;\n}\n.face-modal--themes-tip .face-modal-footer {\n  border-top: none;\n  padding-top: 0;\n  padding-bottom: 1.5em;\n  padding-right: 1.5em;\n}\n", ""]);
...
/***/ "./node_modules/css-loader/index.js!./node_modules/less-loader/index.js!./node_modules/button.react/lib/index.css":
/***/ (function(module, exports, __webpack_require__) {
